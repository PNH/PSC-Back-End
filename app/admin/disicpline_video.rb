...
ActiveAdmin.register LearngingLibrary, as: 'DisciplineResource' do
  ...
  form do |f|
    f.inputs 'Discipline Resource Information' do
      f.input :title
    ...
    f.actions do
      if controller.action_name == 'new'
        f.action(:submit, label: 'Create Discipline Resource')
      else
        f.action(:submit, label: 'Update Discipline Resource')
      end
